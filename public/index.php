...
<div class="wrap">
    ...
    <div class="home-text-container">       
        <div class="home-text-area">
            ...
            <h1>Tecnología e Innovación con Energía Solar</h1>
            <h2>Programa de difusión tecnológica</h2>

        </div>
    </div>

    <div class="home-arrow-container">
        <a id="arrow-down" href="#seccion1">
            <i class="material-icons arrow-down bounce">keyboard_arrow_down</i>
        </a>
    </div>
...
<main class="principal">
            ...
            <div class="pdt-container col-sm-12 col-md-6 col-lg-6">
                ...
                <div class="row center-xs">
                    <div class="col-xs-12 pdt-title">
                        <h1>¿Qué es el Programa de Difusión Tecnológica?</h1>
                    </div>
                </div>
        ...
        <div class="row no-margin">
            ...
            <div class="act-container col-sm-12 col-md-6">
                ...
                <div class="row center-xs">
                    <div class="col-xs-10 col-md-11 col-lg-11">
                        <p class="pdt-content">
                            Conoce todas las actividades, talleres y módulos de capacitación realizados durante el desarrollo del programa.
                        </p>
                    </div>
                    <div class="col-xs-10 col-sm-6 col-md-6 col-lg-6">
    ...
    <section id="seccion3" class="logo-seccion">
...
<script>
    ...
    // Punto de anclaje para cambiar la opacidad del header al llegar a seccion1
